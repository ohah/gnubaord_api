...
trait urllib{
  ...
  public function get_nginx_conf_rules($return_string=false){
  ...
  public function get_mod_rewrite_rules($return_string=false){
  ...
  public function check_need_rewrite_rules(){
